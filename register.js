...
const args = [
    ...
    '--role', 'asp',
    '--name', 'ProjectLens AI',
    '--description', 'ProjectLens AI is an autonomous AI auditing agent that analyzes Web3 projects using GitHub, documentation, and technical evidence to generate transparent, verifiable research reports.',
